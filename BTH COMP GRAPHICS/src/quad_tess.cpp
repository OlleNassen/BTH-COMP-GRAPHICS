	...
	, displacement_map("images/displacement_map.png")
{
	...
	{
		//pos, uv, normal
		-0.5f, -0.5f, 0.f, 1.0f, 0.0f, 256.f, 0.0f, 0.f,
		-0.5f, 0.5f, 0.f, 1.0f, 1.0f, 256.f, 0.0f, 0.f,
		0.5f, -0.5f, 0.f, 0.0f, 1.0f, 256.f, 0.0f, 0.f,

		-0.5f, 0.5f, 0.f, 0.0f, 0.0f, 256.f, 0.0f, 0.f,
		0.5f, 0.5f, 0.f, 1.0f, 0.0f, 256.f, 0.0f, 0.f,
		0.5f, -0.5f, 0.f, 0.0f, 1.0f, 256.f, 0.0f, 0.f
	};
